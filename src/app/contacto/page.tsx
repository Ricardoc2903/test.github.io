...
export default function App() {
  ...
  return (
    <div className="flex flex-col items-center mt-10 mb-16 sm:mb-10 h-screen">
      <div className=" w-1/2 rounded-lg h-96 flex flex-col items-center">
        ...
        <form action="">
          <div className="flex w-80 flex-col px-2 sm:px-0 flex-wrap md:flex-nowrap mb-6 md:mb-0 gap-10">
            ...
            <Input type="message" variant={"underlined"} color="primary" required className=" text-ellipsis" label="Mensaje" />
          </div>
